...
void Application::Display(void)
{
	...
	case 2:
		m_pCamera->ResetCamera();
		m_pCamera->SetPerspective(false); // works
		break;
	case 3:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(vector3(20.0f, 0.0f, 0.0f), vector3(0.0f), -AXIS_Z); // works
		break;
	case 4:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(vector3(0.0f, 0.0f, -17.0f), vector3(0.0f), AXIS_Y); // works
		break;
	case 5:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(vector3(0.0f, 0.0f, -17.0f), vector3(0.0f), AXIS_Y); // works
	...
	case 6:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(vector3(0.0f, 0.0f, -15.0f), vector3(0.0f), AXIS_Y); // works
		m_pCamera->SetNearFar(vector2(0.01f, 10.0f)); // works
		break;
	case 7:
		m_pCamera->ResetCamera();
		m_pCamera->SetPositionTargetAndUpward(vector3(0.0f, 0.0f, 10.0f), vector3(0.0f), -AXIS_Y); // works
		break;
	}
